...
{
    public class LobbyServerListGodlike : MonoBehaviour
    {
        public LobbyManagerGodlike lobbyManager;
		...
		public void OnGUIMatchList(bool success, string extendedInfo, List<MatchInfoSnapshot> matches)
		{
			...
			for (int i = 0; i < matches.Count; ++i)
			{
				...
				o.GetComponent<LobbyServerEntryGodlike>().Populate(matches[i], lobbyManager, (i % 2 == 0) ? OddServerColor : EvenServerColor);
