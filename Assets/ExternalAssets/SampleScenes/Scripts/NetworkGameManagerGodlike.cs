...
public class NetworkGameManagerGodlike : NetworkBehaviour
{
	static public List<NetworkPlayerGodlike> sShips = new List<NetworkPlayerGodlike>();
	static public NetworkGameManagerGodlike sInstance = null;
	...
	public IEnumerator WaitForRespawn(NetworkPlayerGodlike ship)
    {
