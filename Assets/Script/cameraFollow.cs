...
namespace VRStandardAssets.Utils
{
    ...
    public class cameraFollow : MonoBehaviour
    {
        ...
        private void Start ()
        {
			...
			m_DistanceFromCamera = Vector3.Distance (transform.position, Camera.main.transform.position);
        ...
        private void Update()
        {
            ...
            if (m_RotateWithCamera)
            {
				...
				Vector3 targetPosition = Camera.main.transform.position + targetDirection * m_DistanceFromCamera;
